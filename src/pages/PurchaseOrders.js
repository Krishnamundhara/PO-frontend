        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              <strong>Private Data:</strong> These are <strong>your purchase orders only</strong>. 
              Each user has their own separate data - no other user can see or edit these records.
            </p>
          </div>
        </div>
      </div>
