        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Admin Notice:</strong> As an admin, you can manage user accounts, but <strong>each user has their own isolated data environment</strong>. When you create a new user, they will start with a fresh workspace. Users cannot see each other's data.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all the users in the system including their username, email and role.
          </p>
        </div>
            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {users.length === 0 ? (
                    <tr>
                      <td colSpan="4" className="py-4 pl-4 pr-3 text-sm text-center text-gray-500">
                        No users found.
                      </td>
                    </tr>
                  ) : (
