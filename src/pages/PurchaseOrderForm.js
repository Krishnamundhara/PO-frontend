        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              <strong>Private Data:</strong> This purchase order will be visible only to you. 
              Each user maintains their own separate purchase orders that cannot be accessed by other users.
            </p>
          </div>
        </div>
      </div>
